...
final class Camera: NSObject {
    ...
    func stop(_ completionHandler: (() -> Void)? = nil) {
    ...
    func takePhoto() {
        guard let photoOutput = self.photoOutput,
              isProcessing == false else { return }
        isProcessing = true
...
extension Camera: AVCapturePhotoCaptureDelegate {
    ...
    func uploadFile(_ photo: AVCapturePhoto) {
        let cgRepresantation = photo.fileDataRepresentation()!
        let uiimage = UIImage(data: cgRepresantation)!
